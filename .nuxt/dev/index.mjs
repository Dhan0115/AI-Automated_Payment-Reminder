...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getResponseStatus, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL, parseQuery, parsePath, encodePath } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/dhan/Applications/AI-Automated_Payment-Reminder/server/assets"}];
...
const _47Users_47dhan_47Applications_47AI_45Automated_Payment_45Reminder_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dhan/Applications/AI-Automated_Payment-Reminder","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dhan/Applications/AI-Automated_Payment-Reminder/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', _47Users_47dhan_47Applications_47AI_45Automated_Payment_45Reminder_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/Users/dhan/Applications/AI-Automated_Payment-Reminder/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dhan/Applications/AI-Automated_Payment-Reminder/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dhan/Applications/AI-Automated_Payment-Reminder/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/dhan/Applications/AI-Automated_Payment-Reminder/.data/kv"}));
...
const _q1raaTh61Bw_CVw6VXgZRxQRNbX9rZlECvNSxW0XTs = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/dhan/Applications/AI-Automated_Payment-Reminder";
...
const _XmYkAGEAQckEoz4SguTVFGhPF22ofY2ogC8wD_9rjBo = (nitroApp) => {
...
const _JSLHq2ohEo_5W0yZri5vOLMP46h1ilr5dNXJaVpBkI = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _q1raaTh61Bw_CVw6VXgZRxQRNbX9rZlECvNSxW0XTs,
_XmYkAGEAQckEoz4SguTVFGhPF22ofY2ogC8wD_9rjBo,
_JSLHq2ohEo_5W0yZri5vOLMP46h1ilr5dNXJaVpBkI,
...
const _RoDw0_ = eventHandler((event) => {
...
const _VjjaIP = defineCachedEventHandler(async (event) => {
...
const _lazy_bWaJB7 = () => Promise.resolve().then(function () { return smartAdd_post$1; });
const _lazy_7TuvKl = () => Promise.resolve().then(function () { return smartAdd$1; });
const _lazy_7ap1_m = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _RoDw0_, lazy: false, middleware: true, method: undefined },
  { route: '/api/smart-add', handler: _lazy_bWaJB7, lazy: true, middleware: false, method: "post" },
  { route: '/api/smart-add', handler: _lazy_7TuvKl, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_7ap1_m, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _VjjaIP, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_7ap1_m, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_7ap1_m, lazy: true, middleware: false, method: undefined }
];
...
function fallbackParse$1(prompt) {
  let normalized = prompt.toLowerCase().replace(/\s+(?:at|@)\s+/g, "@").replace(/\s+dot\s+/g, ".").replace(/\s+/g, " ");
  const spokenDays = {
    first: 1,
    "1st": 1,
    second: 2,
...
const smartAdd_post = defineEventHandler(async (event) => {
...
const smartAdd_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: smartAdd_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const smartAdd$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: smartAdd
}, Symbol.toStringTag, { value: 'Module' }));
