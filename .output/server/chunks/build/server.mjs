import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, ref, inject, h, Suspense, Fragment, hasInjectionContext, getCurrentInstance, provide, shallowReactive, defineAsyncComponent, computed, unref, shallowRef, createElementBlock, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { m as parseURL, f as encodePath, n as decodePath, o as klona, c as createError$1, q as hasProtocol, s as isScriptProtocol, k as joinURL, w as withQuery, t as defuFn, v as sanitizeStatusCode, x as getContext, $ as $fetch$1, y as baseURL, z as defu, A as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "app",
    path: "/app",
    component: () => import('./app-DebrRic_.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CzDA4yH0.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-QvDKznHI.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BDLrkJjz.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CEHuVQi5.mjs'));
...
export { _export_sfc as _, __nuxt_component_1 as a, useRouter as b, useNuxtApp as c, useRuntimeConfig as d, entry_default as default, encodeRoutePath as e, nuxtLinkDefaults as f, useAppConfig as g, asyncDataDefaults as h, createError as i, navigateTo as n, resolveRouteObject as r, useHead as u };
