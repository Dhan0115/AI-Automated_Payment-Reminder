import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, defineAsyncComponent, computed, defineComponent, h, unref, provide, Suspense, nextTick, mergeProps, createElementBlock, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu, defuFn } from "/Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "/Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/ufo/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/@unhead/vue/dist/index.mjs";
import { klona } from "/Users/dhan/Applications/AI-Automated_Payment-Reminder/node_modules/klona/dist/index.mjs";
...
const _routes = [
  {
    name: "app",
    path: "/app",
    component: () => import("./_nuxt/app-DebrRic_.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CzDA4yH0.js")
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-QvDKznHI.js").then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BDLrkJjz.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CEHuVQi5.js"));
